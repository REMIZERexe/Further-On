...
public class FOCrushingRecipeGen extends CrushingRecipeGen {
    public GeneratedRecipe BAUXITE = create(() -> com.remizerexe.further_on.registry.FOBlocks.BAUXITE.get(), b -> b
            .duration(250)
            .output(com.remizerexe.further_on.registry.FOItems.BAUXITE_DUST.get(), 2)
            .output(1.0f, com.remizerexe.further_on.registry.FOItems.BAUXITE_DUST.get(), 1)
            .output(0.5f, net.minecraft.world.item.Items.CLAY_BALL, 1)
    );

    public GeneratedRecipe FELDSPAR = create(() -> com.remizerexe.further_on.registry.FOItems.feldspar.get(), b -> b
            .duration(250)
    ...
    public GeneratedRecipe COAL = create(() -> net.minecraft.world.item.Items.COAL, b -> b
            ...
            .output(0.5f, com.remizerexe.further_on.registry.FOItems.coal_tar.get(), 1)
            .output(0.1f, com.remizerexe.further_on.registry.FOItems.coal_tar.get(), 1)
    );
